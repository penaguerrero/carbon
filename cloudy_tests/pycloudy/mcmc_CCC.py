...
import mcmc_infrastruc_classes as mcmcis
...
abunds_lists = [[10.94,  8.20,  7.32,  7.07,  7.40,  6.42],   # 0 = iiizw107  ** S from Lop-San09
                ...
                [10.91,  8.00,  7.16,  6.50,  7.26,  6.02],   # 7 = pox4  ** S from Lop-San09 = 6.24
                ...
                [11.07,  8.32,  8.11,  7.71,  7.90,  7.00],   # 15 = arp252  ** S from Lop-San09 = --
                [10.97,  8.55,  7.81,  7.44,  7.66,  6.28],   # 16 = iras08208  ** S from Lop-San09 = 6.39
...
mchammer = mcmcis.MCMC(object_name, manual_measurement, initial_Cloudy_conditions, n_proc, recover=recover)
mchammer.run_chain()

print '\nCode finished! Took  %s  days to finish.' % ((time.time() - start_time) / 86400.0)  # so that the final time is in days.

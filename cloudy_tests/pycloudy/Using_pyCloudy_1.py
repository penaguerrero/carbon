...
plt.legend(loc=3)
destination = os.path.join(pypics_path, 'TeVsRadius.jpg')
...
plt.legend()
destination = os.path.join(pypics_path, 'LineVsRadius.jpg')
plt.savefig(destination)
print('Plot %s was saved!' % destination)
plt.show()
...
plt.legend(loc=3)
destination = os.path.join(pypics_path, 'IonVsRadius.jpg')
plt.savefig(destination)
print('Plot %s was saved!' % destination)
plt.show()
...
destination = os.path.join(pypics_path, 'TeVsNe.jpg')
plt.savefig(destination)
print('Plot %s was saved!' % destination)
plt.show()
...
plt.ylabel('Jy')
plt.legend(loc=4)
destination = os.path.join(pypics_path, 'AngstromVsJansky.jpg')
plt.savefig(destination)
print('Plot %s was saved!' % destination)
plt.show()
